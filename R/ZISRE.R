...
if (family == "Beta") {
  ...
  if (n.chains > 1) {
    ...
    MM <- rbind(cbind(sim1$mean$betaL1, sim1$sd$betaL1, sim1$q2.5$betaL1, sim1$q97.5$betaL1, sim1$Rhat$betaL1),
    ...
    MM <- rbind(cbind(sim1$mean$betaL1, sim1$sd$betaL1, sim1$q2.5$betaL1, sim1$q97.5$betaL1),
